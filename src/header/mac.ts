...
export const calculate = (
 ...
 // The spec doesn't call this out explicitly but the secret key is the sender's
 // when sending and the recipient's when receiving and the public key is the
 // recipients when sending and the sender's when receiving.
 longTermSecretKey: SecretKey.Value,
 longTermPublicKey: PublicKey.Value,
 // The ephemeral secret key is generated by the sender when sending and is the
 // recipient's long term secret key when receiving.
 ephemeralSecretKey: SecretKey.Value,
 // The ephemeral public key is 
